<template>
  <v-container>
    ...
    <v-row>
      <v-col>
        <v-card elevation="0">
          <v-item-group class="imgframe" style="height: 75vh; overflow-y: auto;">
            ...
            <v-row class="mx-auto mx-2"> 
              ...
              <v-col cols="12" md="6" lg="8">
                <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; height: 100%;">
                  <h2 class="font-title" color="primary" style="width: 100%; text-align: center; line-height: 1.5em;">
                    <span class="break-hint">꽃과 풀 열매로</span> 
                    <span class="break-hint"> 크고 작은 공간을 구성합니다</span>
                  </h2>
                  <p>&nbsp;</p>
                  <div style="width: 100%; text-align: center;" class="font-subtitle">
                    <p>
